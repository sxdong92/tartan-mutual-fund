...
<body>
	<div class="container" style="margin-left: 20px">
		...
		<form class="form-horizontal" method="post" action="cchangepwd.do">
		  <div class="form-group">
		    <label class="col-sm-3 control-label">Old Password:</label>
		    <div class="col-sm-8">
		      <input type="password" class="form-control" size="25" maxlength="64" name="oldPassword"  value="" placeholder="UserName">
		    </div>
		  </div>
		  <div class="form-group">
